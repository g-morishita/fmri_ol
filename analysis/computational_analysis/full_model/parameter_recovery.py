...
from analysis.computational_analysis.estimator import FullModel as EstimatorFullModel
...
def main():
    ...
    self_model = FullModel(reward_lr=0.2, action_lr=0.1, weight_for_A=0.3, beta=3)
